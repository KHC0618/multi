...
@RestController //@Controller+@ResponseBody 기능 둘 다 하는 어노테이션이다
...
public class ResponseRestController {
    ...
    public byte[] getImage() throws IOException {
        return getClass().getResourceAsStream("/com/multi/restapi/section01/response/sample.PNG").readAllBytes(); //11버전 //루트 확인 !
        //return Objects.requireNonNull(getClass().getResourceAsStream("/com/multi/restapi/section01/response/sample.PNG")).readAllBytes();
    }

    /* 7. RepsonseEntity(응답 객체)를 이용한 응답
