...
public class Application {
	...
	public static void main(String[] args) {
		...
		// getMessage("읽어올 메세지 키 값", 메세지에 전달 할 데이터, 없으면 null, Locale.?? );
		ApplicationContext context = 
				new AnnotationConfigApplicationContext(ContextConfiguration.class);
		
		
		String error404Message = context.getMessage("error.404", null, Locale.KOREA);//Locale.KOREA
		String error500Message = context.getMessage("error.500", new Object[] {"jenny", new Date()}, Locale.KOREA);
