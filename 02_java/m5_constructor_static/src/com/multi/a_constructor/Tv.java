...
//        private void test() {}    // 컴파일 에러 - 접근 제어자는 메소드 시그니처에 해당하지 않는다.

//        public int test() { return 0; } // 컴파일 에러 - 반환 타입은 메소드 시그니처에 해당하지 않는다.


    public void test(int num) {}    // 매개변수 선언부가 달라서 가능

//    public void test(int num2) {}   // 컴파일 에러 - 매개변수의 이름은 메소드 시그니처에 해당하지 않는다.

    public void test(int num, int num2) {}      // 매개변수의 개수가 다르면 다른 메소드로 인지한다.

    public void test(int num, String str) {}    // 매개변수의 타입이 다르면 다른 메소드로 인지한다.

    public void test(String str, int num) {}    // 매개변수의 순서가 다르면 다른 메소드로 인지한다.
}
