...
public class RedirectServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
         ...
         * 따라서 개인적으로만 사용하는 경우는 크게 상관 없지만 다른 사용자와 함께 사용되는 컴퓨터인 경우에는
         * 쿠키에 민감한 개인정보를 담기에는 보안에 취약하게 된다.
         * 따라서 민감한 개인 정보를 취급하는 경우에는 쿠키보다는 세션이라는 것을 이용하게 된다.
         * 세션은 쿠키와 유사한 형태로 key=value 쌍으로 저장되지만 서버(톰캣)에서 관리되기 때문에
         * 보안에 더 우수하다는 장점을 가지게 된다.
         */
    }
