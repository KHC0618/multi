...
public class ValidTestController { //build.gradle --> spring-boot-starter-validation, lombok
    ...
    }//ExceptionController --> UserNotFoundException
    ...
    }//ExceptionController --> MethodArgumentNotValidException
